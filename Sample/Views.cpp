...
LPCTSTR CStartPageWnd::GetDialogResource() const
{
	return _T("<Dialog>")
		...
		_T("<NavigatorButton name=\"page_configure\" text=\"<i 4> Opsćtning\" />")
		...
		_T("<VerticalLayout>")
		_T("<TextPanel text=\"<f 8>Vćlg startomrĺde?</h>\" />")
		_T("<FadedLine />")
		_T("<TileLayout scrollbar=\"true\" >")
		_T("<TextPanel name=\"link_registers\" text=\"<i 7 50><a><f 6>&Registre</f></a>\n<h>\n<c #444540>Vćlg denne menu for at rette i diverse registre i systemet.\n\nDu kan rette i kunde, vogn og chauffřr-reigsteret.\" shortcut=\"R\" />")
		_T("<TextPanel name=\"link_systems\" text=\"<i 9 50><a><f 6>&Systemer</f></a>\n<h>\n<c #444540>Gennem denne menu kan du opsćtte diverse ting.\" shortcut=\"S\" />")
		_T("<TextPanel name=\"link_configure\" text=\"<i 6 50><a><f 6>Opsćtning</f></a>\n<h>\n<c #444540>Opsćtning giver adgang til konfiguration af de mange křrsels-systemer og regler.\" />")
		_T("<TextPanel name=\"link_reports\" text=\"<i 5 50><a><f 6>Rapporter</f></a>\n<h>\n<c #444540>Rapporter giver dig overblik over registre samt hverdagens ture og bestillinger.\n\nGennem statistik og lister kan du hurtigt fĺ prćsenteret historiske data fra systemet.\" />")
		_T("</TileLayout>")
		_T("</VerticalLayout>")
		_T("</WindowCanvas>")
		_T("</VerticalLayout>")
...
LPCTSTR CConfigurePageWnd::GetDialogResource() const
{
	return _T("<Dialog>")
		...
		_T("<NavigatorButton name=\"page_registers\" text=\"<i 4> Registre\" tooltip=\"Vis forskellige registre\" />")
		_T("<NavigatorButton name=\"page_systems\" text=\"<i 4> Systemer\" />")
		_T("<NavigatorButton name=\"page_configure\" text=\"<i 4> Opsćtning\" selected=\"true\" />")
		_T("<NavigatorButton name=\"page_reports\" text=\"<i 4> Rapporter\" />")
		_T("</NavigatorPanel>")
		_T("</VerticalLayout>")
		_T("<VerticalLayout>")
		_T("<Toolbar>")
		_T("<LabelPanel align=\"right\" text=\"<f 6><c #fffe28>System Opsćtning</c></f>\" />")
		_T("</Toolbar>")
		_T("<ToolbarTitlePanel name=\"titlepanel\" text=\"<f 7>System Opsćtning</f>\" />")
		_T("<TitleShadow />")
		_T("<WindowCanvas>")
		_T("<VerticalLayout>")
		...
		_T("<VerticalLayout>")
		_T("<TextPanel text=\"<f 6><c #2c4378>Opsćtningsliste</c></f>\" />")
		_T("<SeparatorLine />")
		_T("<TextPanel text=\"<c #414141>Dobbeltklik pĺ et element i listen for at konfigurere det.</c>\n\" />")
		...
		_T("<ListLabelElement text=\"<i 4> Chauffřr register\" />")
...
LPCTSTR CRegistersPageWnd::GetDialogResource() const
{
	return _T("<Dialog>")
		...
		_T("<LabelPanel pos=\"0, 0, 150, 24\" text=\"S&řg efter\" />")
		...
		_T("<Button pos=\"100, 98, 150, 118\" name=\"ok\" text=\"Sřg\" />")
		_T("</DialogLayout>")
		_T("</TabPage>")
		_T("</TabFolder>")
		_T("<List name=\"list\">")
...
LPCTSTR CSystemsPageWnd::GetDialogResource() const
{
	return _T("<Dialog>")
		...
		_T("<VerticalLayout>")
		_T("<DialogLayout scrollbar=\"true\" >")
		_T("<LabelPanel pos=\"0, 0, 80, 24\" text=\"<b>&Sřg efter</b>\" stretch=\"group\" />")
		_T("<SingleLineEdit pos=\"80, 2, 220, 22\" name=\"navn\" stretch=\"size_x\" />")
		_T("<Button pos=\"224, 2, 265, 22\" text=\"Sřg\" name=\"ok\" stretch=\"move_x\" />")
...
LPCTSTR CReportsPageWnd::GetDialogResource() const
{
	return _T("<Dialog>")
		...
		_T("<TextPanel text=\"<i 2 50><a><f 6>Chauffřr Rapporter</f></a>\n<h>\n<c #444540>Rapporter for chauffřrer registeret.\" />")
...
LPCTSTR CSearchPageWnd::GetDialogResource() const
{
	return _T("<Dialog caption=\"Search Page\" >")
		_T("<VerticalLayout>")
		_T("<ToolbarTitlePanel text=\"<f 6>Sřg efter en vej.</f><p><x 10>Indtast sřgekriterier og sřg efter vejen.\" />")
		_T("<DialogCanvas>")
		_T("<VerticalLayout>")
		_T("<DialogLayout>")
		...
		_T("</DropDown>")
		_T("<LabelPanel pos=\"0, 36, 60, 60\" text=\"Sřg\" stretch=\"group\" />")
		_T("<SingleLineEdit pos=\"60, 38, 250, 58\" name=\"search\" text=\"\" stretch=\"size_x\" />")
		_T("<Button pos=\"260, 38, 340, 58\" name=\"ok\" text=\"&Sřg\" stretch=\"move_x\" />")
...
LPCTSTR CEditPageWnd::GetDialogResource() const
{
	return _T("<Dialog caption=\"Rediger Person\" >")
		...
		_T("<SingleLinePick pos=\"110, 62, 240, 82\" text=\"<i 3><a>Bjarke Viksře</a>\" stretch=\"size_x\" />")
		...
		_T("<SingleLinePick pos=\"110, 132, 240, 152\" text=\"<a>Nřrrebred, Vallensbćk</a>\" stretch=\"size_x\" />")
		_T("<LabelPanel pos=\"260, 130, 370, 154\" text=\"Note\" stretch=\"move_x\" />")
		_T("<MultiLineEdit pos=\"370, 132, 510, 192\" text=\"Dette er en meget lang note omkring denne person. Her fřlger noget mere tekst\" stretch=\"move_x size_x\" />")
		...
		_T("<ListLabelElement text=\"2625 Vallensbćk\" />")
		_T("</DropDown>")

		_T("<Option pos=\"0, 192, 120, 212\" text=\"Husnr krćvet\" selected=\"true\" />")
		_T("<Option pos=\"120, 192, 240, 212\" text=\"Ikke krćvet\" />")
		_T("</DialogLayout>")
		_T("</TabPage>")
...
LPCTSTR CPopupWnd::GetDialogResource() const
{
	return _T("<Dialog>")
		_T("<VerticalLayout>")
		_T("<ToolbarTitlePanel text=\"<f 6>Er du sikker?</f><p><x 10>Er du sikker pĺ at du har trykket pĺ linket?\" />")
		_T("<DialogCanvas>")
		_T("<VerticalLayout>")
		_T("<TextPanel text=\"Det er ikke altid godt at trykke pĺ linket. Du kan fortryde dit klik ved at vćlge Nej knappen.\" />")
		_T("<PaddingPanel />")
		_T("<DialogLayout>")
		_T("<PaddingPanel pos=\"0, 0, 340, 4\" />")
		_T("<SeparatorLine  pos=\"0, 4, 340, 18\" stretch=\"group size_x\" />")
